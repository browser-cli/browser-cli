...
export type { RateLimits, RateLimitDecl, BucketSpec } from './store/rate-limit.ts'
export { acquireSlot } from './store/concurrency.ts'
export type { SlotHandle } from './store/concurrency.ts'
